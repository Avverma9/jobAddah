...
export default function AllAdmitCards() {
  ...
  const loading = admitCards?.loading;
  const list = admitCards?.data || [];
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Manage and monitor all published admit card entries.
          </p>
        </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border-t border-slate-100 text-left text-sm">
                <thead className="bg-slate-50/80 text-xs uppercase tracking-wide text-slate-500">
                  <tr>
                    <th className="px-4 py-3 font-medium">Admit card</th>
