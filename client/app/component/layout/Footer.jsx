      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-black tracking-tight text-white">
                Jobs<span className="text-indigo-500">Addah</span>
              </span>
            </div>

            <p className="text-sm font-medium leading-relaxed text-slate-400">
              Bharat ki bharosemand website jahan aapko milti hai Jobs,
              Results, Admit Cards aur Admissions ki sabse pehle aur
              sateek jankari.
            </p>
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-t border-slate-800 pt-8 text-center md:flex-row">
          <p className="text-sm font-medium text-slate-500">
            © 2026 jobsaddah.com. All Rights Reserved.
          </p>
