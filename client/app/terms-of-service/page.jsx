...
export const metadata = buildMetadata({
  ...
  description:
    "Read JobsAddah terms and conditions, non-government disclaimer, liability limits, and user responsibilities.",
  path: "/terms-of-service",
  type: "WebPage",
  keywords: ["jobsaddah terms and conditions", "user agreement", "non government disclaimer"],
});
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-t-2xl shadow-sm border border-gray-100 p-8 sm:p-12 border-b-4 border-blue-600">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            Welcome to <strong>JobsAddah</strong>. By accessing this website (https://jobsaddah.com), we assume you accept these terms and conditions in full. Do not continue to use JobsAddah if you do not agree to all of the terms and conditions stated on this page.
          </p>
        </div>
        ...
        <div className="bg-white rounded-b-2xl shadow-sm border border-gray-100 p-8 sm:p-12 space-y-10">
          ...
          <section className="bg-red-50 p-6 rounded-xl border border-red-100">
            ...
            <p className="text-gray-800 font-medium mb-2">
              JobsAddah is a privately owned information portal and is NOT affiliated with the Government of India, any State Government, or any Public Sector Undertaking (PSU).
            </p>
          ...
          <section className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-3">
                Unless otherwise stated, JobsAddah and/or its licensors own the intellectual property rights for all material on JobsAddah. All intellectual property rights are reserved. You may access this from JobsAddah for your own personal use subjected to restrictions set in these terms and conditions.
              </p>
              <p className="font-semibold text-gray-700 mb-2">You must not:</p>
              <ul className="list-disc pl-5 space-y-1 text-gray-600">
                <li>Republish material from JobsAddah on other websites or apps.</li>
                <li>Sell, rent, or sub-license material from JobsAddah.</li>
                <li>Reproduce, duplicate, or copy material from JobsAddah for commercial gain.</li>
                <li>Redistribute content from JobsAddah (unless content is specifically made for redistribution).</li>
              </ul>
            </div>
          </section>
          ...
          <section className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                The information provided on JobsAddah is for general informational purposes only. While we endeavor to keep the information up to date and correct, we make no representations or warranties of any kind, express or implied, about the completeness, accuracy, reliability, suitability, or availability with respect to the website.
              </p>
              <div className="bg-gray-50 p-4 rounded-lg text-sm text-gray-700 border-l-4 border-gray-400">
                <strong>Limitation of Liability:</strong> In no event shall JobsAddah be liable for any loss or damage including without limitation, indirect or consequential loss or damage, or any loss or damage whatsoever arising from loss of data or profits arising out of, or in connection with, the use of this website. If a user misses a deadline or pays a fee to a fake entity due to confusion, JobsAddah shall not be held responsible.
              </div>
            </div>
          </section>
            ...
            <div className="flex flex-col md:flex-row gap-8 text-gray-600 text-sm">
              <div className="flex items-start gap-3">
                ...
                <address className="not-italic">
                  <strong>JobsAddah Legal Dept.</strong><br />
              ...
              <div>
                ...
                <p><strong>Email:</strong> support@jobsaddah.com</p>
              </div>
            </div>
          </section>
