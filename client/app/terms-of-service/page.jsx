      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-t-2xl shadow-sm border border-gray-100 p-8 sm:p-12 border-b-4 border-blue-600">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            Welcome to <strong>SarkariAfsar</strong>. By accessing this website (https://jobsaddah.com), we assume you accept these terms and conditions in full. Do not continue to use SarkariAfsar if you do not agree to all of the terms and conditions stated on this page.
          </p>
        </div>
