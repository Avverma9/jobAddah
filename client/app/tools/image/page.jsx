...
export default function ImageEditor() {
  ...
  return (
    <div className="force-light">
      <SEO 
        title="Online Image Resizer & Passport Photo Maker | JobsAddah"
        description="Free online tools to resize images, remove backgrounds, create passport size photos, and join images for sarkari exam forms."
        keywords="image resizer, passport photo maker, bg remover, image joiner, online image editor, jobsaddah image tool"
      />
      <style jsx global>{`
