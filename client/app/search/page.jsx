...
export async function generateMetadata({ searchParams }) {
  ...
  const title = query
    ? `Search Jobs and Results: ${query}`
    : "Search Government Jobs, Results, Admit Cards";
  const description = query
    ? `Find results for ${query} across JobsAddah job posts, admit cards, answer keys, and exam results.`
    : "Search verified JobsAddah job posts, admit cards, answer keys, and results.";
  ...
  return buildMetadata({
    ...
    noIndex: true,
    keywords: ["jobsaddah search", "search jobs", "search sarkari result"],
  });
}
