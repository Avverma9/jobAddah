              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@jobsaddah.com" className="text-gray-700 hover:text-blue-600 block mt-1 break-all">
                      support@jobsaddah.com
                    </a>
                    <a href="mailto:ads@jobsaddah.com" className="text-sm text-gray-500 hover:text-blue-600 block mt-1">
