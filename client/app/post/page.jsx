...
const JobSectionsPage = ({ className = "" }) => {
  ...
  return (
    ...
    >
      <SEO 
        ...
        description="Official JobsAddah Sarkari Result portal. Get latest government job updates, admit cards, results, and answer keys in one place."
      />
      {/* --- Main Content Grid --- */}
              ...
              >
                ...
                <div className="px-4 py-3 border-b border-slate-100 flex items-center justify-between group cursor-move">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      title="View All"
                      // Prevent drag start if clicking the link
                ...
                {filteredJobs.length >= 15 && (
                  <div className="px-4 py-2 border-t border-slate-100">
                    <button
                      type="button"
                      onClick={() => router.push(`/view-all?name=${encodeURIComponent(category.name)}&link=${encodeURIComponent(category.link)}`)}
...
export function PostSections(props) {
  return <JobSectionsPage {...props} />;
}

export default JobSectionsPage;
