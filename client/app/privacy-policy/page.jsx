          ...
          <section className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mt-4">
                To exercise any of these rights, please contact us at <a href="mailto:support@jobsaddah.com" className="text-blue-600 hover:underline">support@jobsaddah.com</a>. We will respond within 30 days.
              </p>
            </div>
          </section>
              ...
              <div>
                ...
                <div className="text-sm text-gray-600 space-y-2">
                  <p className="flex items-center gap-2">
                    ...
                    <a href="mailto:support@jobsaddah.com" className="text-blue-600 hover:underline">support@jobsaddah.com</a>
                  </p>
                  <p className="flex items-center gap-2">
