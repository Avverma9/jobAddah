      ...
      <head>
        ...
        {/* <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `(function(s){s.dataset.zone='10387080',s.src='https://nap5k.com/tag.min.js'})([document.documentElement, document.body].filter(Boolean).pop().appendChild(document.createElement('script')))`,
          }}
        /> */}
      </head>
      <body
