  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="md:hidden">
        ...
        {/* Search Overlay - Z-Index bumped to 100 to stay above header */}
        {showSearch && (
      ...
      <main className="pb-20 md:pb-0">
        ...
        <div className="md:hidden">
          {/* Tools overlay: show only when activeView requests tools and we're not already on a tool route */}
          {activeView === "tools" && !(
            pathname && (
              pathname.includes("/pdf-tool") ||
              pathname.includes("/image-tool") ||
            ...
            // Inline private jobs view for mobile when pvt tab clicked (and not already on /private-jobs route)
            <PrivateJobsView 
            ...
            // Show upcoming deadlines / expiring soon on mobile when deadlines tab clicked
        ...
        {/* Desktop: always render children inside main */}
