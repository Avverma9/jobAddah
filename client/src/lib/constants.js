...
export const TOOLS_CONFIG = [
  { name: "PDF Tools", path: "/pdf-tool", icon: "FileText" },
  { name: "Image Resize", path: "/image-tool", icon: "Image" },
  { name: "Resume Maker", path: "/resume-maker", icon: "Award" },
  { name: "Typing Test", path: "/typing-test", icon: "Type" },
  { name: "Quiz App", path: "/quiz-and-earn", icon: "Briefcase" },
];
