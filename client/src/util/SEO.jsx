  ...
  const defaultJsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        name: siteName,
        description:
          "India's leading sarkari result portal for government jobs, admit cards, and exam results",
      ...
      },
      {
        ...
        description:
          "JobsAddah provides latest sarkari result, government job notifications, admit cards, and exam results.",
        sameAs: [
