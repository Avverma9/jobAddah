...
const tools = [
  ...
  },
  {
    id: 4,
    title: "Resume",
    fullTitle: "Resume Maker",
    description: "Build Instantly",
    icon: <ReceiptSwissFranc className="w-5 h-5 sm:w-6 sm:h-6" />,
    status: "active",
    href: "/jobsaddah-resume-tools",
    badge: "New",
    color: "yellow",
  },
  {
...
const ToolCard = ({ tool }) => {
  ...
  const containerClasses =
    "aspect-square w-full rounded-full flex flex-col items-center justify-center text-center transition-all duration-300 relative overflow-hidden p-1 sm:p-3";
  ...
  if (isActive) {
    return (
      ...
      >
        ...
        <div
          className={`p-1.5 sm:p-2.5 rounded-full mb-1 sm:mb-1.5 transition-colors duration-300 ${
            colorClasses[tool.color]
          } ring-0 sm:ring-4 ring-white`}
        >
          {tool.icon}
        </div>
  ...
  return (
    <div
      className={`group ${containerClasses} bg-gray-50 border border-gray-100 sm:border-4 sm:border-gray-100 opacity-90 cursor-not-allowed`}
    >
      ...
      <div
        className={`p-1.5 sm:p-2.5 rounded-full mb-1 sm:mb-1.5 bg-gray-200 text-gray-400 grayscale`}
      >
        {tool.icon}
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-6 sm:mb-10 relative z-10">
          <div className="relative inline-block">
            ...
            <div
              className="absolute -bottom-1 -left-3 sm:-bottom-2 sm:-left-6 animate-float"
