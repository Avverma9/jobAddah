...
import { 
  Upload, Layers, Maximize2, Download, Trash2, Columns, Rows, 
  Eraser, Check, RefreshCw, Clipboard, Palette, Move, Scissors, 
  ...
  return (
    <Card>
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-grow bg-slate-200 dark:bg-slate-900 rounded-xl overflow-auto flex items-center justify-center p-4 min-h-[500px] border border-slate-300 dark:border-slate-700">
  ...
  return (
    <Card>
      <div className="grid md:grid-cols-4 gap-6">
        ...
        <div 
          className={`md:col-span-3 rounded-lg flex items-center justify-center p-4 min-h-[500px] relative overflow-hidden ${isTransparent ? 'bg-checkered' : ''}`}
        ...
        >
          ...
          <canvas 
            ...
            className={`max-w-full max-h-[500px] shadow-xl object-contain ${!image ? 'hidden' : ''} ${tool === 'eraser' ? 'cursor-crosshair' : 'cursor-pointer'}`}
          />
  ...
  return (
    <Card>
       <div className="grid md:grid-cols-3 gap-6">
           ...
           <div className="md:col-span-2 order-1 md:order-2 bg-gray-200 rounded-xl flex items-center justify-center p-4 min-h-[400px]">
               <canvas 
                ref={canvasRef} 
                className="max-w-full max-h-[500px] shadow-lg cursor-move"
  ...
  return (
      <Card>
          <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="w-full md:w-2/3 bg-gray-200 rounded-xl flex items-center justify-center p-4 min-h-[400px]">
                  <canvas ref={canvasRef} className={`max-w-full max-h-[500px] shadow-lg ${!image ? 'hidden' : ''}`} />
    ...
    return (
        <Card>
            <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2 bg-gray-200 rounded-xl flex items-center justify-center p-4 min-h-[400px]">
                    <canvas ref={canvasRef} className={`max-w-full max-h-[500px] shadow-lg ${(!images.img1 && !images.img2) ? 'hidden' : ''}`} />
